...
echo $mail->sendEmail($recepient, $sender, $subject, $message, $name, $phone, $is_sender_required, $is_subject_required, $is_message_required, $is_name_required, $is_phone_required);
